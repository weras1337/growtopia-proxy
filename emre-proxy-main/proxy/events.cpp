    ...
    if (var.get(0).m_key == "action" && var.get(0).m_value == "input") {
        ...
        //deleted for private reasons ;)
            ...
            paket =
                ...
                "\nadd_textbox|`4IMPORTANT: `oDiscord: emre#9999.|left|2480|"
                "\nadd_quick_exit|"
                "\nend_dialog|end|Cancel|Okay|";
            variantlist_t liste{ "OnDialogRequest" };
            liste[1] = paket;
...
"\nadd_spacer|small|\n\nadd_url_button||`1Join Discord Server``|NOFLAGS||Open link?|0|0|"
"\nadd_textbox|`wDecember 26th: `5Don't Forget Join Discord Server  |left|"
"\nadd_spacer|small|"
"\nadd_textbox|`wDecember 26th: `5Proxy made by emre#9999 |left|"
"\nadd_spacer|small|"
...
"\nadd_textbox|Don't forget to join our `2Official Proxy Discord Server`` on `2 `` or click the link below!|left|"
"\nadd_textbox|Visit our Social Media pages for more Content!|left|"
"\nadd_spacer|small|"
"\nadd_layout_spacer|2imageslayout|"
"\nadd_image_button|iotm_layout_4|interface/large/gazette/gazette_5columns_social_btn04.rttex|5imageslayout|"
"UCLZOpt3XfT1Pp9U4JUC6SzQ|Would you like to open this in Youtube?|"
"\nadd_image_button|iotm_layout_4|interface/large/gazette/gazette_5columns_social_btn06.rttex|5imageslayout| you like to join our "
"discord?|"
"\nadd_layout_spacer|2imageslayout|"
"\nadd_textbox||\nadd_spacer|small|"
"\nadd_textbox||\nadd_spacer|small|"
